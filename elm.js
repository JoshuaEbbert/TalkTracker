			...
			if (_p0._0.ctor === 'Ok') {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							numSpcMusic: _p2,
							spcMusicalNumbers: _user$project$TalkTracker$fixSpcMusicalNumbersRecord(_p2)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {numSpeakers: a, numSpcMusic: b, ward: c, date: d, time: e, conducting: f, organist: g, chorister: h, openingHymn: i, invocation: j, sacramentHymn: k, speakers: l, spcMusicalNumbers: m, closingHymn: n, benediction: o};
														};
													};
												};
											};
...
if (typeof _user$project$TalkTracker$main !== 'undefined') {
    _user$project$TalkTracker$main(Elm['TalkTracker'], 'TalkTracker', undefined);
}
