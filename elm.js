							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$TalkTracker$viewInputField, model.inputFields)),
									_1: {
										ctor: '::',
										_0: A2(
...
var _user$project$TalkTracker$Model = function (a) {
	return {inputFields: a};
};
var _user$project$TalkTracker$NumSpeakers = function (a) {
	return {ctor: 'NumSpeakers', _0: a};
};
